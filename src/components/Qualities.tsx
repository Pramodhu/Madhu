...
const AnimatedBackground = () => {
  ...
  const randomTexts = ['Love', 'Joy', 'Chinnu', 'Muahhh', '💖', 'Cutyy'];
...
const Qualities = () => {
  ...
  const qualities = [
    { icon: "✨", title: "Your Eyes", desc: "They take my breath away." },
    { icon: "😘", title: "Your Smile", desc: "A massage to my soul." },
    { icon: "👣", title: "Your Walk", desc: "Big fan right from school days." },
    { icon: "😍", title: "Your Body", desc: "I'm in love with the shape of you." },
    { icon: "🥺", title: "Your Love", desc: "An eternal, heavenly boon that defies all logic! " },
