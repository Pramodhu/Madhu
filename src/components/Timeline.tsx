...
const Timeline = () => {
  ...
  const timelineEvents = [
    { icon: "📽️", title: " Movie Date ", desc: "Lets decide the movie together." },
    { icon: "🎮", title: "Game Date", desc: "Any online game of your choice." },
    { icon: "🔮", title: "Reminisce Date", desc: "A voyage through time and space." },
    { icon: "❔", title: "Your Date", desc: "You decide what its gonna be." }
  ];
