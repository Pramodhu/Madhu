...
const WhyMe = () => {
  ...
  const whyMeReasons = [
    { icon: "🫂", title: "I'm a One Woman Man", desc: "Best partner you could have!" },
    { icon: "🏋️‍♀️", title: "I give my all", desc: "My 100 % efforts to see you smile." },
    { icon: "🤗", title: "I'm never gonna stop loving you", desc: "Of course you do know that." },
